package com.app.foodninja.adapters
...
import com.app.foodninja.databinding.OnboardingItemBinding
...
class OnBoardingItemListAdapter(
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val binding =
            OnboardingItemBinding.inflate(LayoutInflater.from(context), container, false)
